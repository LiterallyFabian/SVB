...
function createPosts() {
    connection.query("SELECT * FROM posts", function (err, result, fields) {
        ...
        result.forEach(post => fs.readFile(__dirname + "/../posttemplate.html", 'utf8', function (err, data) {
            if (err) {
            ...
            fs.writeFile(__dirname + `/../public/articles/${post.url}.html`, file, function (err) {
